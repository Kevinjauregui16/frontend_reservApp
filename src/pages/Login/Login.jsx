  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl flex items-center justify-between px-8">
        {/* Lado izquierdo - Logo */}
        <div className="flex-1 flex items-center justify-center py-48 bg-blue-10/10 rounded-3xl shadow-2xl mr-8">
          <a
            href="/"
            className="text-5xl font-extrabold whitespace-nowrap text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-500"
          >
            ✨ReservaPro
          </a>
        </div>
